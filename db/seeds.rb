...
Article.create(:allow_comments => true, :allow_pings => true, :author => "Mr Typo", :body => "Welcome to Typo. This is your second article. Edit or delete it, then start blogging!", :guid => "1bf3e2cb-ed7b-4562-8a4a-8ce8438822c8", :id => 2, :permalink => "hello-world-again", :post_type => "read", :published => true, :published_at => "2012-06-09 21:51:56 UTC", :settings => {"password"=>""}, :state => "published", :text_filter_id => 5, :title => "Hello Again", :type => "Article", :user_id => 1)
...
# Comment.create(type: "Comment", title: nil, author: "ich", body: "My Comment 1", excerpt: nil, user_id: 1, guid: "ed624a0e-1d8e-4602-9f04-b857d6789aa4", text_filter_id: nil, whiteboard: nil, article_id: 1, email: "df@sdhg.de", url: "", ip: "127.0.0.1", blog_name: nil, published: true, published_at: nil, state: "ham", status_confirmed: true)
# Comment.create(type: "Comment", title: nil, author: "ich", body: "My Comment 2", excerpt: nil, user_id: 1, guid: "fd624a0e-1d8e-4602-9f04-b857d6789aa4", text_filter_id: nil, whiteboard: nil, article_id: 1, email: "df@sdhg.de", url: "", ip: "127.0.0.1", blog_name: nil, published: true, published_at: nil, state: "ham", status_confirmed: true)
# Comment.create(type: "Comment", title: nil, author: "ich", body: "The new Comment", excerpt: nil, user_id: 1, guid: "gd624a0e-1d8e-4602-9f04-b857d6789aa4", text_filter_id: nil, whiteboard: nil, article_id: 2, email: "df@sdhg.de", url: "", ip: "127.0.0.1", blog_name: nil, published: true, published_at: nil, state: "ham", status_confirmed: true)
